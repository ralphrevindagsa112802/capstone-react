...
file_put_contents("log_sales.txt", date("Y-m-d H:i:s") . " - total_sales.php accessed\n", FILE_APPEND);
...
try {
    ...
    file_put_contents("log_sales.txt", date("Y-m-d H:i:s") . " - Orders table exists\n", FILE_APPEND);
    ...
    file_put_contents("log_sales.txt", date("Y-m-d H:i:s") . " - Total sales fetched: " . $result["total_sales"] . "\n", FILE_APPEND);
    ...
    file_put_contents("log_sales.txt", date("Y-m-d H:i:s") . " - DB Error: " . $e->getMessage() . "\n", FILE_APPEND);
    http_response_code(500);
    echo json_encode(["success" => false, "message" => "Database error: " . $e->getMessage()]);
} catch (Exception $e) {
    file_put_contents("log_sales.txt", date("Y-m-d H:i:s") . " - General Error: " . $e->getMessage() . "\n", FILE_APPEND);
    http_response_code(500);
