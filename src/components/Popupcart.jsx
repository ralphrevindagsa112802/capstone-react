    ...
    return (
        <AnimatePresence>
            <motion.div 
                ...
                className="fixed bottom-20 right-4 z-50 w-96 bg-white shadow-2xl rounded-xl border border-gray-200 overflow-hidden"
                style={{ 
                ...
                {cartItems.length === 0 ? (
                    ...
                    >
                        <div className="text-gray-300 text-6xl mb-4">
                            <ShoppingCart className="mx-auto w-20 h-20" strokeWidth={1} />
                        </div>
                        <p className="font-semibold text-gray-700 text-xl">Your cart is empty</p>
                    ...
                    <>
                                ...
                                {cartItems.map((item) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-grow">
                                            <h3 className="font-bold text-[#1C359A] text-base">{item.food_name}</h3>
                        ...
                        <div className="p-4 bg-gray-50 border-t">
                            <div className="flex justify-between mb-4">
                                ...
                                <span className="text-lg font-bold text-[#1C359A]">₱{totalAmount.toFixed(2)}</span>
                            </div>
                            <div className="grid grid-cols-2 gap-3">
                                <Link 
                                    to="/user/cart" 
                                    onClick={onClose}
                                    className="text-center bg-gray-200 text-gray-700 py-3 rounded-lg hover:bg-gray-300 transition-colors flex items-center justify-center space-x-2"
                                >
                                ...
                                <button 
                                    ...
                                    className="bg-[#1C359A] text-white py-3 rounded-lg hover:bg-blue-800 transition-colors flex items-center justify-center space-x-2"
                                >
                                    <ShoppingCart className="w-5 h-5" />
                                    <span>Checkout</span>
                                </button>
