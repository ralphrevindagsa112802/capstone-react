...
const UserStatus = () => {
  ...
  useEffect(() => {
    axios.get(`https://yappari-coffee-bar-system.free.nf/yappari-coffee-bar-api/api/getOrder.php?orderId=${orderId}`)
      .then(response => {
  ...
  const handleCancelOrder = () => {
    axios.post(`https://yappari-coffee-bar-system.free.nf/yappari-coffee-bar-api/api/cancelOrder.php`, { orderId })
      .then(response => {
  ...
  const handleOrderReceived = () => {
    axios.post(`https://yappari-coffee-bar-system.free.nf/yappari-coffee-bar-api/api/orderReceived.php`, { orderId })
      .then(response => {
        if (response.data.success) {
